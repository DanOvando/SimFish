#' CatchCurve assessment module
#'
#' @param LengthDat length data
#' @param CatchCurveWeight the weight assigned to the catch curve
#' relative to other method of calculating mortality
#' AgeBased slides catch curve weight in proportion to the age of the MPA
#' @param WeightedRegression 1 or 0 to use weighted regression by Smith et al
#' @param ReserveYr year that MPA goes in place
#' @param OutsideBoundYr A year marker for any selectivity changes outside the MPA
#' @param ManualM Manual natural mortality
#' @param GroupMPA no idea
#' @param Iterations number of iterations to run
#' @param BootStrap 1 or 0 to bootstrap
#' @param LifeError 1 or 0 for life history error
#' @param HistInterval bin width of age histogram
#'
#' @return list with values from catch curve
#' @export
